...
class Spare(models.Model):
    ...
    part = models.ForeignKey(Part, default=1, on_delete=models.SET_DEFAULT)
...
class LineData(models.Model):
    line = models.ForeignKey(Line, default=1, on_delete=models.SET_DEFAULT)
    part = models.ForeignKey(Part, default=1, on_delete=models.SET_DEFAULT)
    sub_assembly = models.ForeignKey(Sub_Assembly, default=1, on_delete=models.SET_DEFAULT)
